...
const bool isHermesProvisioningGateConfigured =
    bool.fromEnvironment('ELLA_HERMES_PROVISIONING_GATE', defaultValue: true);
const bool isHermesProvisioningGateEnabled =
    SharedPreferencesUtil.isPublicBuild || isHermesProvisioningGateConfigured;
