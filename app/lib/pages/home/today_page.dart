...
class TodayHardwareStatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final necklaceArtworkState = necklaceConnected && !necklaceConnecting
        ? EllaHardwareArtworkState.on
        : EllaHardwareArtworkState.off;
                  ...
                  children: [
                    Expanded(
                      child: _HardwareTile(
                        ...
                        visual: _HardwareArtworkVisual(imagePath: necklaceImagePath, reconnecting: necklaceConnecting),
                      ),
                    ),
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        if (reconnecting) const Positioned(right: 5, bottom: 6, child: EllaBreathingDot(active: true, live: true)),
      ],
    );
  }
}
