...
and protocol 1 sockets close with WebSocket policy code 1008 before a Firestore
conversation or capture-authority document is created.
...
6. Re-enable capture traffic and verify v2 receipts for every supported codec.
