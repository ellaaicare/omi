...
ELLA_HERMES_PROVISION_API_REVIEWED_ALLOWLIST=http://<mac-mini-tailscale-ip>:8210
ELLA_HERMES_PROVISION_AUTHORITY_BINDING_REF=env:ELLA_HERMES_PROVISION_AUTHORITY_BINDING
ELLA_HERMES_PROVISION_AUTHORITY_BINDING=<root-only reviewed URL/token binding>
```
