...
async def update_conversation_summary(
    ...
    try:
        ...
        if cas_preconditions is not None:
            ...
            for legacy_only_argument in (
                "correction_audit_updater",
                "require_based_on_match",
                "require_canonical",
                "expected_transcript_hash",
                "require_source_match",
                "today_card_grounding_evidence",
            ):
                writer_args.pop(legacy_only_argument)
        else:
...
async def get_conversation_data(
    ...
    payload = conversation_data_payload(uid=uid, conversation_id=conversation_id, conversation=conversation)
