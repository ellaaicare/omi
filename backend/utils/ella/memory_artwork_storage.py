...
except ImportError:  # pragma: no cover - exercised by production test stubs without GCS.
    storage = None
...
class GCSMemoryArtworkStore:
    ...
    def __init__(self, *, bucket_name: Optional[str] = None, client: Optional[storage.Client] = None):
        ...
        if storage is None:
            raise MemoryArtworkStorageError("memory_artwork_storage_dependency_unavailable")
